            ...
            <div className="navigation--list">
                <Drawer
                    ...
                    <div className="ps-panel--wrapper">
                        ...
                        <div className="ps-panel__content">
                            <PanelMenu selectMenu={this.handleDrawerClose} />
                        </div>
                    </div>
                </Drawer>
                <Drawer
                    ...
                    <div className="ps-panel--wrapper">
                        ...
                        <div className="ps-panel__content">
                            <PanelCartMobile selectCart={this.handleDrawerClose} />
                        </div>
                    </div>
                </Drawer>
                <Drawer
                    ...
                    <div className="ps-panel--wrapper">
                        ...
                        <div className="ps-panel__content">
                            <PanelSearch
                                selectSearch={this.handleDrawerClose}
                            />
                        </div>
                    </div>
                </Drawer>
                <Drawer
                    ...
                    <div className="ps-panel--wrapper">
                        ...
                        <div className="ps-panel__content">
                            <PanelCategories selectCategories={this.handleDrawerClose} />
                        </div>
                    </div>
                </Drawer>
