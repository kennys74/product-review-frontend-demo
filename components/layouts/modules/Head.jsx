...
const StyleSheets = () => (
    <Head>
        <title>Yuppiechef - Product reviews demo</title>
        ...
        <meta name="author" content="Kenneth Sutherland" />
        <meta name="keywords" content="air fryers" />
        <meta name="description" content="Yuppiechef - Product reviews demo" />
        <link
